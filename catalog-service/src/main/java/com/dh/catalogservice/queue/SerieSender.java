...
public class SerieSender {
    ...
    public void sendMsgToOtherConsumer(Movie movie) {
        LOGGER.info(String.format("Json message sent to ALL -> %s", movie.toString()));
        rabbitTemplate.convertAndSend(topicExchange.getName(), "#", movie);
    }
}
